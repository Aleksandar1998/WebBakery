...
function setDates(){
    ...
    $.ajax({
        type: "POST",
        url: "../../controllers/productionControllers/setDateController.php",
        data: "1",
...
function generateGraph(){
    ...
    $.ajax({
        type: "POST",
        url: "../../controllers/productionControllers/graphController.php",
        data: json,
        success: function (data) {
            if(data == ""){
                ...
                if(tip==0){
                    ...
                    arrayValues = Object.values(obj.vrednosti);
                        ...
                        graph(Object.values(obj.datumi), Object.values(obj.vrednosti), "Proizvedena količina");
